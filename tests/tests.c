...
int main() {
  ...
  assert(0, ({
         ...
         "({ g2[0]=0; g2[1]=1; g2[2]=2; g2[3]=3; g2[0]; })");
  assert(1, ({
           g2[0] = 0;
           g2[1] = 1;
           g2[2] = 2;
         ...
         "({ g2[0]=0; g2[1]=1; g2[2]=2; g2[3]=3; g2[1]; })");
  assert(2, ({
           g2[0] = 0;
           g2[1] = 1;
           g2[2] = 2;
         ...
         "({ g2[0]=0; g2[1]=1; g2[2]=2; g2[3]=3; g2[2]; })");
  assert(3, ({
           g2[0] = 0;
           g2[1] = 1;
           g2[2] = 2;
         ...
         "({ g2[0]=0; g2[1]=1; g2[2]=2; g2[3]=3; g2[3]; })");
  ...
  assert(2, ({
         ...
         "({ struct {char a; int b; char c;} x; x.b=1; x.b=2; x.c=3; x.b; })");
  assert(3, ({
           struct {
             char a;
             int b;
  ...
  assert(20, ({
         ...
         "({ struct t {char a[20];}; { struct t {char a[40];}; } struct t y; sizeof(y); })");
  assert(3, ({
           struct t {
             int x;
           };
